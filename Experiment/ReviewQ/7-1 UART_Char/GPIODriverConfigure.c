...
unsigned char I2C0PullUpTest(void)	//测试I2C上拉电阻是否工作
{

/****************************Put your code here!!************************************/
	GPIOPinTypeGPIOInput(I2C0_PIN_BASE, I2C0SCL_PIN | I2C0SDA_PIN);	  	//设置I2C0用到的两个引脚为GPIO输入模式
	//并设置上述两引脚为弱下拉推挽模式，驱动电流8MA
	GPIOPadConfigSet(I2C0_PIN_BASE, I2C0SCL_PIN | I2C0SDA_PIN, GPIO_STRENGTH_8MA, GPIO_PIN_TYPE_STD_WPD);
/************************************************************************************/
	
	SysCtlDelay(SysCtlClockGet()/1500);  //延时1/500秒，即2 ms
	//测试外部上拉是否发挥作用
