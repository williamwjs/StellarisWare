...
/****************************Put your code here!!************************************/
	ulStatus=I2CMasterIntStatus(I2C0_MASTER_BASE, true);	//读取I2C0主机的中断状态
	I2CMasterIntClear(I2C0_MASTER_BASE);			//清除I2C0主机的中断状态
	if (I2CMasterErr(I2C0_MASTER_BASE)!=I2C_MASTER_ERR_NONE)	//检测I2C0主机传输是否遇到故障，若遇到，则立即退出中断服务函数
	{
