...
void GPIOInitial(void)
{
	...
	GPIOIntTypeSet(KEY_PRESS_BASE,KEY_PRESS_PIN,
				   GPIO_FALLING_EDGE);					//Press中断
	GPIOPinIntEnable(KEY_PRESS_BASE,KEY_PRESS_PIN);
	
	GPIOIntTypeSet(KEY_LEFT_BASE,KEY_LEFT_PIN,
				   GPIO_FALLING_EDGE);					//Left中断
	GPIOPinIntEnable(KEY_LEFT_BASE,KEY_LEFT_PIN);
	
	GPIOIntTypeSet(KEY_RIGHT_BASE,KEY_RIGHT_PIN,
				   GPIO_FALLING_EDGE);					//Right中断
	GPIOPinIntEnable(KEY_RIGHT_BASE,KEY_RIGHT_PIN);
	
	GPIOIntTypeSet(KEY_UP_BASE,KEY_UP_PIN,
				   GPIO_FALLING_EDGE);					//Up中断
	GPIOPinIntEnable(KEY_UP_BASE,KEY_UP_PIN);
	
	GPIOIntTypeSet(KEY_DOWN_BASE,KEY_DOWN_PIN,
				   GPIO_FALLING_EDGE);					//Down中断
