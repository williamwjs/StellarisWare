...
/****************************Put your code here!!************************************/
	...
	I2CMasterInitExpClk(I2C0_MASTER_BASE,SysCtlClockGet(),true);		//设置I2C0主机模块传输速率为400kbps（高速模式）
	I2CMasterEnable(I2C0_MASTER_BASE);			//使能I2C主机模块
	I2CMasterIntEnable(I2C0_MASTER_BASE);		//使能I2C主机模块中断
/************************************************************************************/
	...
	I2CMasterTransmit_Burst_2Bytes(I2C0_MASTER_BASE,LED_I2CADDR,PCA9557_REG_OUTPUT,0x02);
	IntEnable(INT_I2C0);
}
